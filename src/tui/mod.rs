...
// Old single-session run_app body has been replaced by the Coordinator.
// The App struct, start_disc_scan, poll_background, handle_settings_save,
// and apply_settings_to_session remain below for run_settings and as
// adapter functions during the transition.
